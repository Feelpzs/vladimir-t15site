// lobby_volibear.js – Lógica do carrossel e painel de matchup para Volibear
...
// Objeto que armazenará os dados de matchups (json sintaxe idêntica ao modelo)
let matchups = {};
fetch("../json/matchups_completo.json")
  .then(response => response.json())
  .then(data => {
    matchups = data;
    console.log("Matchups Volibear carregados!", matchups);
  })
  .catch(err => console.error("Erro ao carregar matchups Volibear:", err));
